...
public class EmergencyAmbulance extends AppCompatActivity {
    ...
    private CollectionReference notebookRef = db.collection("EmergencyAmbulance");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                textViewData2.setText(getString(R.string.search_results_for, search2));
                ...
                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(EmergencyAmbulance.this, R.layout.sample_view, R.id.text11,al);

                notebookRef.whereEqualTo("tag", search2).orderBy("name", Query.Direction.ASCENDING).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            @Override
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Intent intent = new Intent(EmergencyAmbulance.this, ResultShow.class);
    ...
    protected void onStart() {
        ...
        final ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(EmergencyAmbulance.this, R.layout.sample_view, R.id.text11,al2);
