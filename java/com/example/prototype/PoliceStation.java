...
public class PoliceStation extends AppCompatActivity {
    ...
    private CollectionReference notebookRef = db.collection("PoliceStation");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.prototype.R.layout.activity_police_station);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(PoliceStation.this, R.layout.sample_view, R.id.text11,al);
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Intent intent = new Intent(PoliceStation.this, ResultShow.class);
    ...
    protected void onStart() {
        ...
        final ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(PoliceStation.this, R.layout.sample_view, R.id.text11,al2);
