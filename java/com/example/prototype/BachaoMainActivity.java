...
public class BachaoMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bachao_activity_main);
        ...
        toggle = new ActionBarDrawerToggle(BachaoMainActivity.this, drawerLayout, R.string.drawer_open, R.string.drawer_close);
    ...
    public void onBackPressed() {
        //AlertDialog
        alertdialog = new AlertDialog.Builder(BachaoMainActivity.this);
        ...
        database.getReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.hasChild(mAuth.getCurrentUser().getUid())){
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(BachaoMainActivity.this);
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.emergencyCardView) {
            showEmergencyAlertDialog();
        } else if (v.getId() == R.id.contactCardView) {
            startActivity(new Intent(BachaoMainActivity.this, ContactActivity.class));
        } else if (v.getId() == R.id.settingsCardView) {
            sendUserToSettingsActivity();
        }
    }
    ...
    public void callEmergency(){
        if(ContextCompat.checkSelfPermission(BachaoMainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(BachaoMainActivity.this, new String[] {Manifest.permission.CALL_PHONE}, REQUEST_CALL);
        }
        //make call to 999
        else{
            String dial = "tel:" + "999";
    ...
    private void sendUserToLoginActivity() {
        Intent intent = new Intent(BachaoMainActivity.this, SignInActivity.class);
    ...
    private void aboutDeveloper() {
        dialog = new Dialog(BachaoMainActivity.this);
    ...
    private void fetchLastLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(BachaoMainActivity.this, new String[]
    ...
    private void sendUserToSettingsActivity() {
        Intent intent = new Intent(BachaoMainActivity.this, SettingsActivity.class);
        startActivity(intent);
    }

    private void requestPermissions() {
        if(ContextCompat.checkSelfPermission(BachaoMainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(BachaoMainActivity.this, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED ||
                ContextCompat.checkSelfPermission(BachaoMainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(BachaoMainActivity.this, new String[] {Manifest.permission.CALL_PHONE, Manifest.permission.SEND_SMS, Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_CODE);
        }
    }
