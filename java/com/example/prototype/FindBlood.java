...
public class FindBlood extends AppCompatActivity {
    ...
    private CollectionReference notebookRef = db.collection("FindBlood");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(FindBlood.this, R.layout.sample_view, R.id.text11,al);
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Intent intent = new Intent(FindBlood.this, ResultShow.class);
    ...
    protected void onStart() {
        ...
        final ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(FindBlood.this, R.layout.sample_view, R.id.text11,al2);
